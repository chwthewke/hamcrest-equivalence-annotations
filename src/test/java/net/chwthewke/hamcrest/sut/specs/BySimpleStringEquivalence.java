...
import net.chwthewke.hamcrest.sut.equivalences.SimpleStringEquivalence;

@EquivalenceSpecificationOn( WithPublicProperty.class )
public interface BySimpleStringEquivalence {

    @ByEquivalence( SimpleStringEquivalence.class )
    int getIntValue( );
