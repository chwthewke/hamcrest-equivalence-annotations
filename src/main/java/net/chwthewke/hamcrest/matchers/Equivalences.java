...
/**
 * This class has some factory methods to create {@link Equivalence} instances from <em>equivalence specifications</em>
 * (i.e. classes
...
public final class Equivalences {
     ...
     *            {@link net.chwthewke.hamcrest.annotations.EquivalenceSpecificationOn} (with <code>value()</code> equal
     *            to <code>matchedType</code>).
     * @param matchedType
     *            The matched type.
    ...
    /**
     * Creates an {@link Equivalence} from the equivalence specification <code>equivalenceSpecification</code>.
     * Contrary to {@link #asSpecifiedBy(Class, Class)}, the resulting equivalence has a specified supertype of
     * the matched type as its type parameter. However, using the equivalence with items that are not instances of
     * the matched type with result in an error.
     * 
     * @param <T>
     *            The matched type.
     * @param <U>
     *            The type parameter of the resulting equivalence.
     * @param equivalenceSpecification
     *            The equivalence specification, which must be annotated with
     *            {@link net.chwthewke.hamcrest.annotations.EquivalenceSpecificationOn} (with <code>value()</code> equal
     *            to <code>matchedType</code>).
     ...
     * @return an {@link Equivalence} as specified by <code>equivalenceSpecification</code>.
     */
    public static <U, T extends U> Equivalence<U> asSpecifiedBy( final Class<?> equivalenceSpecification,
            final Class<T> matchedType, final Class<U> equivalenceType ) {
        return new WidenedEquivalence<U, T>(
            new CompositeEquivalence<T>(
                PROPERTY_FINDER,
                SPECIFICATION_VALIDATOR,
                matchedType,
                equivalenceSpecification ), matchedType );
    }
     ...
     * @return an {@link Equivalence} as specified by <code>equivalenceSpecification</code>.
     *         <p>
     *         Note: this convenience method allows to eschew the second parameter on the condition that the equivalence
     *         specification extend the marker interface {@link EquivalenceSpecification}. Moreover, this is less safe
     *         than the alternative, as the matched type cannot be checked at runtime.
     */
